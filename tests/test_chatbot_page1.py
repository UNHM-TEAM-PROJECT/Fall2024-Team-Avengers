...
import pytest
from chatbot_fat import get_response

# Call the main function to initialize the model and embedding components
...
@pytest.mark.parametrize("question, expected_answer", expected_responses_page1.items())
def test_chatbot_page1_responses(question, expected_answer):
